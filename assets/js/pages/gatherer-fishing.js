...
function fishHtml(x){
 if(x.error){
   return `<article class="fish-direct-item"><div class="fish-direct-head"><h3><a class="external-name-link" href="${officialSearch(x.name)}" target="_blank" rel="noopener">${FF14Tools.esc(x.name)}</a></h3></div><p>釣り条件を自動取得できませんでした。</p></article>`;
 }
 return `<article class="fish-direct-item">
   <div class="fish-direct-head"><h3><a class="external-name-link" href="${officialSearch(x.name)}" target="_blank" rel="noopener">${FF14Tools.esc(x.name)}</a></h3></div>
